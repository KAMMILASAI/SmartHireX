...
public class AdminController {
    ...
    public ResponseEntity<Map<String, Object>> getAdminStats() {
        ...
        List<Map<String, Object>> recentUsers = allUsers.stream().limit(10).map(u -> {
            ...
            m.put("email", u.getEmail());
            m.put("role", u.getRole() != null ? u.getRole().name().toLowerCase() : "unknown");
            m.put("createdAt", u.getCreatedAt() != null ? u.getCreatedAt().toString() : null);
            // Presence-based status for admin dashboard recent users table
            m.put("isOnline", u.getId() != null && presenceService.isUserOnline(u.getId()));
            return m;
        }).collect(Collectors.toList());
