...
export default function SendNotification() {
  ...
  const audience = 'all'; // Always send to all users
    ...
    <div className="send-notification-root">
      ...
      <form className="send-notification-form" onSubmit={handleSubmit}>
        ...
        <div className="send-notification-actions">
          <button type="submit" disabled={loading || !title.trim() || !message.trim()}>{loading ? 'Sending...' : 'Send Notification to All Users'}</button>
        </div>
      </form>
